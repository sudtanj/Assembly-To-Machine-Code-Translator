...
public class Converter {
	...
	public static void maindua(String program2){
		String opCode=ReadFile.loadFile("instruction.txt");
		String program=ReadFile.loadFile(program2);
		...
		for (String temp : result){
			...
			out.print(converterDecimal(temp.replace("0x", "")));
			out.println();
		}
		System.out.println("Result is also saved in output.txt in the same folder as this program!");
		out.close();
	}
}
